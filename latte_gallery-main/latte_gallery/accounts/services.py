...
from latte_gallery.accounts import models, schemas
from latte_gallery.accounts.repository import UserRepository
from security.dependencies import verify_password, get_password_hash
...
class UserService:
    ...
    def __init__(self, db: Annotated[get_db, Depends()]) -> None:
...
get_current_user =  security.dependencies.get_current_user
class UserService:
